...
function getNodeColor(type) {
    const colorMap = {
        'Project': '#F39C12',        // 旧项目节点（兼容）
        'News': '#F1C40F',           // 新闻节点
        'Theme': '#9B59B6',          // 主题词云
        'Location': '#E67E22',       // 位置词云
        'Pollution': '#E74C3C',      // 污染源词云
        'Time': '#3498DB',           // 时间词云

        'ThemeCategory': '#8E44AD',  // 主题聚合
        'LocationRegion': '#D35400', // 位置聚合
        'PollutionSource': '#C0392B',// 污染源聚合
        'TimePeriod': '#2980B9',     // 时间聚合
        'TimeNode': '#5DADE2',       // 具体日期

        'Executor': '#1ABC9C',       // 执行组织
        'CombinedContent': '#2ECC71',// 措施效果
        'Measure': '#27AE60',
        'Effect': '#16A085',

        // 兼容历史分类（如果图数据库里还存在这些label）
        'LocationCategory': '#F5B041',
        'PollutionCategory': '#F1948A',
        'TimeCategory': '#85C1E9'
    };
